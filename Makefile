...
GCC_FLAGS = -c -Wall -m32 -ggdb -nostdinc -fno-builtin -fno-stack-protector -g -mno-sse
...
image: build
	...
	gcc ${include} ${GCC_FLAGS} -o file.o fs/file.c
	gcc ${include} ${GCC_FLAGS} -o dir.o fs/dir.c
	gcc ${include} ${GCC_FLAGS} -o fork.o userprog/fork.c
	...
	gcc ${include} ${GCC_FLAGS} -o wait_exit.o userprog/wait_exit.c
	gcc ${include} ${GCC_FLAGS} -o pipe.o shell/pipe.c	
	ld -m elf_i386 -Ttext 0xc0001500 -e main -o ${kernelBin} main.o init.o interrupt.o print.o kernel.o timer.o debug.o string.o bitmap.o memory.o thread.o list.o switch.o sync.o console.o keyboard.o ioqueue.o tss.o process.o syscall.o syscall_init.o stdio.o stdio_kernel.o ide.o fs.o inode.o dir.o file.o fork.o shell.o buildin_cmd.o exec.o assert.o wait_exit.o pipe.o
